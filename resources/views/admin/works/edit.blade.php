                                            ...
                                            <label class="block">
                                                ...
                                                @foreach ($type_works as $type_work)
                                                    <option value="{{ $type_work->id }}"
                                                        @selected(old('type_work_id', $work->type_work_id) == $type_work->id)
                                                    >{{ $type_work->name }}</option>
                                                @endforeach
                                                </select>
                                            ...
                                            <label>
                                                ...
                                                <span class="relative mt-1.5 flex">
                                                    <input
                                                        ...
                                                        value="{{ old('completion_date', $work->completion_date->format('Y-m-d')) }}"
                                                    />
                                                    <span
                        ...
                        <div class="card space-y-5 p-4 sm:p-5">
                            ...
                            <label class="block">
                                ...
                                <select x-init="$el._x_tom = new Tom($el)" name="associate_consultants[]"  class="mt-1.5 w-full" multiple placeholder="Seleccione un Asociado..." autocomplete="off">
                                    ...
                                    <option value="{{$associate_consultant->id }}" @selected($work->associate_consultants->contains($associate_consultant->id))> {{$associate_consultant->name}}</option>
                                    @endforeach
                                </select>
